...
import { Calendar, Users, Ship, Clock, Phone, MapPin, User } from 'lucide-react';
...
const TelegramCrewApp: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined' && window.Telegram?.WebApp) {
      ...
      document.body.style.backgroundColor = telegramApp.backgroundColor || (isDark ? '#1f2937' : '#ffffff');
      document.body.style.color = telegramApp.textColor || (isDark ? '#ffffff' : '#000000');
    ...
    const mockData: SeaTrip[] = [
      {
        ...
        status: 'planned',
        crew: [
          { id: 1, name: 'Иван Петров', position: 'Капитан', phone: '+7-911-123-45-67', experience: '15 лет' },
          { id: 2, name: 'Алексей Морозов', position: 'Помощник капитана', phone: '+7-911-234-56-78', experience: '8 лет' },
          { id: 3, name: 'Сергей Волков', position: 'Механик', phone: '+7-911-345-67-89', experience: '12 лет' },
          { id: 4, name: 'Дмитрий Белов', position: 'Рыбак', experience: '5 лет' }
        ]
      },
      {
        date: '2025-06-10',
        ...
        status: 'planned',
        crew: [
          { id: 5, name: 'Николай Козлов', position: 'Капитан', phone: '+7-911-456-78-90', experience: '20 лет' },
          { id: 6, name: 'Андрей Рыбин', position: 'Боцман', phone: '+7-911-567-89-01', experience: '10 лет' },
          { id: 7, name: 'Михаил Морской', position: 'Рыбак', experience: '7 лет' },
          { id: 8, name: 'Олег Штормов', position: 'Рыбак', experience: '3 года' }
        ]
      },
      {
        date: '2025-06-12',
        ...
        status: 'planned',
        crew: [
          { id: 9, name: 'Владимир Океанов', position: 'Капитан', phone: '+7-911-678-90-12', experience: '18 лет' },
          { id: 10, name: 'Евгений Приливов', position: 'Механик', phone: '+7-911-789-01-23', experience: '14 лет' },
          { id: 11, name: 'Артем Глубинов', position: 'Рыбак', experience: '6 лет' }
        ]
      }
    ];
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex items-center">
                    ...
                    <span>Выход: {selectedTrip.departure} | Возвращение: {selectedTrip.estimatedReturn}</span>
                  </div>
                  <div className="flex items-center">
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm">
                ...
                <div className="space-y-3">
                  {selectedTrip.crew.map(member => (
                    <div key={member.id} className="border-l-4 border-blue-600 pl-3 py-2">
                      <div className="font-medium text-gray-900">{member.name}</div>
                      <div className="text-sm text-blue-600 font-medium">{member.position}</div>
                      <div className="text-sm text-gray-500">Опыт: {member.experience}</div>
                      {member.phone && (
